         ...
         <div class="row" style="width: 100%">
            ...
            <div class="form-group col-md-12">
                    ...
                    <div class="input-group">
                      ...
                      <input placeholder="Digite a rua" maxlength="254" id="rua" class="form-control" name="rua" type="text">
                    </div>
            </div>
            ...
            <div class="form-group col-md-12">
                    ...
                    <div class="input-group">
                      <span class="input-group-addon"><i class="material-icons md-18">add_location</i></span>
                      <input placeholder="Digite a cidade" maxlength="254" id="cidade" class="form-control" name="cidade" type="text">
                    </div>
            </div>
            <div class="form-group col-md-12">
                    ...
                    <div class="input-group">
                      <span class="input-group-addon"><i class="material-icons md-18">add_location</i></span>
                      <input placeholder="Digite o Estado" maxlength="254" id="estado" class="form-control" name="estado" type="text">
                    </div>
            </div>
