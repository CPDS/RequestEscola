        ...
        <form id="form" role="form" method="post">
         <div class="row" style="width: 100%">
          ...
          <div class="form-group col-md-12">
            ...
            <input placeholder="Digite o tipo de Ambiente" maxlength="254" id="nome" class="form-control" name="nome" type="text">
          </div>
          ...
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              ...
              <textarea placeholder="Digite a descrição do tipodo ambiente" maxlength="254" class="form-control" id="descricao" name="descricao" type="text"></textarea> 
            </div> 
          </div>
