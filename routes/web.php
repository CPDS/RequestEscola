...
Route::group(['middleware' => ['auth']], function() {
		...
		//Rotas de Reservas de equipamamento
		Route::group(['prefix'=> 'reserva-equipamento', 'where' => ['id'=>'0-9+']], function (){
			...
			Route::get('/atendidos',['as' => 'reserva-equipamento.atendidos', 'uses' => 'ReservaEquipamentoController@atendidos'])->middleware('role:Administrador|Funcionário');
